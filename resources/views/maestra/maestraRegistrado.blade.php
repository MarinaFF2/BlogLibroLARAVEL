    ...
    <body>
        <header>
            <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
                <a class="navbar-brand" href="bienvenidaR">
                    <h1>Tsundoku</h1>
                </a>
                ...
                <div class="collapse navbar-collapse"  id="menu">
                    <ul class="navbar-nav">
                        <li class="nav-item active">
                            <a href="bienvenidaR" class="nav-link">Home</a>
                        </li>
                        <li class="nav-item">
                            <a  class="nav-link" href="noticiasR">Noticias</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Listar Libros</a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="porNombreR">Por Nombre</a>
                                <a class="dropdown-item" href="porAutorR">Por Autor</a>
                                <a class="dropdown-item" href="BuscarR">Buscar</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Area Libros</a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="aniadirLibrosR">Añadir Libros</a>
                            </div>
                        </li>
                    </ul>
                </div>
                <form action="PerfilR" method="POST">
