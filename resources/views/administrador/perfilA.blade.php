...
<div clas="container">
    <div class="row">
        <div class="col-sm col-md col-lg">
            <div class="breadcrumb">
                <div class="breadcrumb-item"><a href="bienvenidaA">Home</a></div>
    ...
    <div class="row justify-content-center mt-5 mb-5">                 
        ...
        <div class="col-md-4 col-sm-4 col-lg-4 mt-2">
            <form action="modificarFotoA" method="POST" enctype="multipart/form-data">
    ...
    <div class="row justify-content-center mt-5 mb-5">  
        <div class="col-md-4 col-sm-4 col-lg-4  mt-2">
            <form action="perfilA" method="POST" enctype="multipart/form-data">
